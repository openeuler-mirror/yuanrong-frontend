...
func TestApplyEventFormatsS3RootfsAsImage(t *testing.T) {
	...
	const s3RootfsJSON = `{"instanceID":"inst-abc","tenantID":"default","instanceStatus":{"code":3},` +
		`"scheduleOption":{"extension":{"rootfs":"{\"runtime\":\"runsc\",\"type\":\"s3\",\"imageurl\":\"registry.example.com\",\"storageInfo\":{\"endpoint\":\"cn-hangzhou.example.com\",\"bucket\":\"crfs-dev\",\"object\":\"rootfs.img\",\"accessKey\":\"secret-ak\",\"secretKey\":\"secret-sk\"}}"}}}`
