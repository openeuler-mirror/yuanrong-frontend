...
// and ExtractIP replicate the C++ TraefikCache helpers byte-for-byte.
package route
...
// SanitizeID replicates TraefikCache::SanitizeID: '@' becomes "-at-",
...
// ExtractIP replicates TraefikCache::ExtractIP: it returns the substring
