...
// of the frontend config. When absent the router starts with default settings;
// set Enabled=false to disable it explicitly.
type SandboxRouterConfig struct {
	...
	RouteBackend     string `json:"routeBackend" valid:"optional"`
	...
	// Backend TLS for https-protocol sandbox ports, equivalent to
	// FunctionMaster's serversTransport. Defaults mirror the platform
	// yr-backend-tls setting; BackendTLSVerify opts into verification.
	BackendTLSVerify     bool   `json:"backendTLSVerify" valid:"optional"`
	BackendTLSCAFile     string `json:"backendTLSCAFile" valid:"optional"`
	BackendTLSCertFile   string `json:"backendTLSCertFile" valid:"optional"`
	BackendTLSKeyFile    string `json:"backendTLSKeyFile" valid:"optional"`
	BackendTLSServerName string `json:"backendTLSServerName" valid:"optional"`
}
