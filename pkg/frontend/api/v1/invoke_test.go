...
func (c *fakeFailedClient) CreateInstanceRaw(createReq []byte, option util.RawRequestOption) ([]byte, error) {
	return nil, nil
}

func (c *fakeFailedClient) InvokeInstanceRaw(invokeReq []byte, option util.RawRequestOption) ([]byte, error) {
	return nil, nil
}

func (c *fakeFailedClient) KillRaw(killReq []byte, option util.RawRequestOption) ([]byte, error) {
	return nil, nil
}
